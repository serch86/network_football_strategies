...
G.add_node(6, name='F. Guitierrez')
...
#MDP- Matriz de Pases
MDP=([0,1,0,0,2,3,0,8,1,0,0],[0,0,1,1,6,7,1,0,7,0,4],[1,0,0,12,6,7,3,3,0,10,6],
     [3,1,7,0,3,1,0,16,2,2,6],[0,2,3,0,0,2,2,1,2,3,6],[0,4,6,1,10,0,0,2,0,4,2],
     [0,3,2,1,3,1,0,2,2,1,1],[5,0,4,11,6,4,1,0,19,5,9],[6,4,3,2,5,3,3,7,0,6,6],
     [1,2,6,3,2,3,0,3,2,0,5],[2,4,8,6,4,7,3,9,3,2,0])
...
#MDP- Matriz de Pases
MDP=([0,3,2,3,1,4,0,4,1,1,3],[0,0,5,3,4,0,10,3,4,15,11],[4,10,0,7,1,7,0,0,1,2,3],
     [6,5,5,0,1,5,0,0,1,0,7],[0,4,2,1,0,1,3,0,2,0,1],[0,1,1,7,1,0,10,0,17,7,11],
     [0,9,0,1,0,5,0,0,3,1,1],[0,2,0,0,1,1,0,0,3,0,0],[0,2,3,2,11,4,3,1,0,1,1],
     [0,5,2,0,1,2,0,4,6,0,1],[3,4,5,10,3,13,11,0,1,1,0])
